        ...
        fetch(baseUrl + 'users/login/', {
            ...
            .then((response) => {
                ...
                if (response.success) {
                    ...
                    sessionStorage.setItem("unpublishedHostingId", response.unpublished_hosting_id === 0 ? null: response.unpublished_hosting_id);
        ...
        return(
            <div>
                <Navbar bg="dark" variant="dark" expand="lg">
                        <Container>
                        <NavLink as={Link} to={"/home"} style={{ textDecoration: 'none' }}><Navbar.Brand >Sunset Vacations</Navbar.Brand></NavLink>
    ...
    renderNavBar2(){
        return(
            <Navbar bg="dark" variant="dark">
                <Container fluid>
                    <Navbar.Brand href="#">Sunset Vacations</Navbar.Brand>
